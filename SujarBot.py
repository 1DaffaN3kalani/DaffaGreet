...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Thanks For Add Me By ە─ঊ➴͜✯͜͡1SUJAR✯͜͜͡~ঈ~~
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Oyyy","Radisti Assist","Come"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye Bye","Bye all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#---------------------
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "Welcome Di Grup  " + str(ginfo.name))
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like By:  ە─ঊ➴͜✯͜͡1SUJAR✯͜͜͡~ঈ~~")
